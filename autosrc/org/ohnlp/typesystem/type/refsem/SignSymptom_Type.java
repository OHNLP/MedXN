...
public class SignSymptom_Type extends Event_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.ohnlp.typesystem.type.refsem.SignSymptom");
  ...
  public int getAlleviatingFactor(int addr) {
      ...
      jcas.throwFeatMissing("alleviatingFactor", "org.ohnlp.typesystem.type.refsem.SignSymptom");
  ...
  public int getBodyLaterality(int addr) {
      ...
      jcas.throwFeatMissing("bodyLaterality", "org.ohnlp.typesystem.type.refsem.SignSymptom");
  ...
  public int getBodySide(int addr) {
      ...
      jcas.throwFeatMissing("bodySide", "org.ohnlp.typesystem.type.refsem.SignSymptom");
  ...
  public int getBodyLocation(int addr) {
      ...
      jcas.throwFeatMissing("bodyLocation", "org.ohnlp.typesystem.type.refsem.SignSymptom");
  ...
  public int getCourse(int addr) {
      ...
      jcas.throwFeatMissing("course", "org.ohnlp.typesystem.type.refsem.SignSymptom");
  ...
  public int getDuration(int addr) {
      ...
      jcas.throwFeatMissing("duration", "org.ohnlp.typesystem.type.refsem.SignSymptom");
  ...
  public int getEndTime(int addr) {
      ...
      jcas.throwFeatMissing("endTime", "org.ohnlp.typesystem.type.refsem.SignSymptom");
  ...
  public int getExacerbatingFactor(int addr) {
      ...
      jcas.throwFeatMissing("exacerbatingFactor", "org.ohnlp.typesystem.type.refsem.SignSymptom");
  ...
  public String getSeverity(int addr) {
      ...
      jcas.throwFeatMissing("severity", "org.ohnlp.typesystem.type.refsem.SignSymptom");
  ...
  public int getStartTime(int addr) {
      ...
      jcas.throwFeatMissing("startTime", "org.ohnlp.typesystem.type.refsem.SignSymptom");
  ...
  public int getRelativeTemporalContext(int addr) {
      ...
      jcas.throwFeatMissing("relativeTemporalContext", "org.ohnlp.typesystem.type.refsem.SignSymptom");
